...
public class Pessoas extends JPanel{
    ...
    public Pessoas(){
        ...
        // Botão de adicionar pessoas
        addButton = new JButton("Cadastrar uma pessoa");
        ...
        description = new JLabel("<html>Aqui você pode ver as pessoas que estão cadastradas no sistema e suas informações. Apenas as pessoas listadas aqui podem ser vinculadas à uma consulta. Para editar um registro de uma pessoa, clique sobre a linha que deseja editar e então uma tela será aberta onde será possível modificar as informações. Para excluir uma pessoa, clique no ícone da lixeira na extremidade direita do registro que deseja remover.</html>");
